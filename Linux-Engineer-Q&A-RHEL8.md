...
7. What are the log files you will validate in RHEL8 on routine basis?
   Ans:
...
8. How you will identify status of WWN ID on RHEL8?
   Ans:
   # systool -c fc_host -v
...
9. What’s the CLI use to validate HBA card port status?
   Ans:
   # lspci
